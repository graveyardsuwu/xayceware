...
local ThemeManager = {} do
	ThemeManager.Folder = 'Xayceware Settings'
	-- if not isfolder(ThemeManager.Folder) then makefolder(ThemeManager.Folder) end

	ThemeManager.Library = nil
	ThemeManager.BuiltInThemes = {
		['Default'] 			= { 1, httpService:JSONDecode('{"FontColor":"bbbbbb","MainColor":"141414","AccentColor":"2544ff","BackgroundColor":"1c1c1c","OutlineColor":"3c3c3c"}') },
		['Standard'] 		= { 2, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"1c1c1c","AccentColor":"0055ff","BackgroundColor":"141414","OutlineColor":"323232"}') },
